...
function RoomsPage() {
    ...
    const handleSubmit = (e)=>{
        ...
        if (editingRoom) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('อัปเดตข้อมูลห้องเรียบร้อย');
        } else {
            // Add new room
            const newRoom = {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('เพิ่มห้องใหม่เรียบร้อย');
        }
        resetForm();
    };
    ...
    const handleDelete = (roomId)=>{
        if (confirm('คุณต้องการลบห้องนี้หรือไม่?')) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('ลบห้องเรียบร้อย');
        }
    };
    const resetForm = ()=>{
        setFormData({
